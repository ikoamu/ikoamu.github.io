  ...
  return (
    ...
    <StyledProfile>
      ...
      <div className="buttons" style={{marginBottom: 16}}>
        <button className="aesthetic-windows-95-button" style={{width: '100%', height: '100%'}}>Follow</button>
        <button className="aesthetic-windows-95-button" style={{marginLeft: 8, width: 66, height: '100%'}}>・・・</button>
      </div>
      <div>
        0 followers 0following ☆0
      </div>
      <div>
        Organizations
        □□□□□□□□□□□□□□□
